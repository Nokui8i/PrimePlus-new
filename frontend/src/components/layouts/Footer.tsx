      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-lg font-bold mb-4">PrimePlus+</h3>
            <p className="text-gray-300 text-sm mb-4">
              The premium subscription platform for content creators. Connect with fans, monetize your content, and build your brand.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/discover" className="text-gray-300 hover:text-white text-sm">Discover</Link></li>
              <li><Link href="/creators" className="text-gray-300 hover:text-white text-sm">Creators</Link></li>
              <li><Link href="/pricing" className="text-gray-300 hover:text-white text-sm">Pricing</Link></li>
              <li><Link href="/features" className="text-gray-300 hover:text-white text-sm">Features</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8">
          <p className="text-gray-400 text-sm text-center">
            &copy; {currentYear} PrimePlus+ Platform. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
